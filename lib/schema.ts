...
export function generateLocalBusinessSchema() {
  return {
    ...
    description: `${BUSINESS_INFO.tagline}. Professional DJ, MC, Photo Booth, and Photography services for weddings, Sweet 16 and 15th birthday celebrations, corporate events, and private parties in Los Angeles and Orange County.`,
